...
Нужно добавить:
Кэширование
Оценка релевантности (кворум), чтоб не выдавать мусор.
Суммаризацию доделать
И структурировать и кластеризовать выдачу
Исследование по векторному индексу. Надо чтобы проверили разные конфигурации ANN и остановились на лучший (а не сразу на Flatt). Добавить latency, пропускная способность, throuput. И понять что можно улучшить.
По ранжированию подумать о би энкодере, а на BM25 можно подумать что потюнить (коэффы, proximity, нормализация, стэмминг).
